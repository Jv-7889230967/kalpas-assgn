    ...
    return (
        <div className={`sidebar_container box_shadow ${openForm === true ? "w-[calc(90vw)] md:w-[calc(70vw)]" : "w-fit lg:w-full"}`}>
            <section className="h-full w-[25%] lg:w-full mt-[6rem] max-w-[25rem] hidden lg:flex flex-col items-center gap-[30px]">
                <div className="h-[15%] w-[80%] min-h-[70px] flex items-center px-[15px] gap-[18px] bg-[#FFFFFF] rounded-[8px] box_shadow">
                    <Image
                ...
                {!openForm && <div className="h-[25%] w-[80%] min-h-[90px] flex flex-col items-center justify-evenly rounded-[8px] bg-[#FFFFFF] box_shadow">
                    <p className="text-[28px] font-semibold">View Toggle</p>
                    <div className="h-[40%] w-[70%] rounded-[8px]">
                        <button
                ...
                <div className="h-[25%] w-[80%] min-h-[90px] flex flex-col items-center justify-evenly rounded-[8px] bg-[#FFFFFF] box_shadow">
